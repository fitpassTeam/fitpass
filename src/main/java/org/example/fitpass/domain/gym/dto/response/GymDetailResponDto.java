...
public record GymDetailResponDto(String name, String number, String content, String address,
                                 LocalTime openTime, LocalTime closeTime, List<String> gymImage,
    ...
    public static GymDetailResponDto from(String name, String number, String content,
        ...
        List<String> trainerNames, GymStatus gymStatus) {
        return new GymDetailResponDto(name, number, content, address, openTime, closeTime, gymImage,
            trainerNames, gymStatus);
    }
