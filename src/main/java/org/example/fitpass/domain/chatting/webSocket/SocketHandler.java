...
import org.example.fitpass.domain.chatting.dto.request.ChatMessageRequestDto;
import org.example.fitpass.domain.chatting.service.AwsS3Service;
import org.example.fitpass.domain.chatting.service.ChatMessageService;
...
public class SocketHandler extends TextWebSocketHandler {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception{
        ...
        ChatMessageRequestDto chatMessageRequestDto = new ChatMessageRequestDto(
            ...
            (String) obj.get("msg"),
            null,
            Integer.parseInt((String) obj.get("roomNumber"))
        );
